...
if (isset($_POST['login'])) {
    ...
    if ($result->num_rows > 0) {
        ...
        if ($row['role_type'] == "admin" || $row['role_type'] == "owner") {
            ...
            //Get Owner Details
            $_SESSION['user_id'] = $row['role_type'] == 'admin' ? $row['user_id'] : $rowOwner['owner_id'];
            header("Location:dashboard.php");
                    ...
                    <div class="nk-block nk-block-middle nk-auth-body  wide-xs">
                        ...
                        <div class="card card-bordered">
                            <div class="card-inner card-inner-lg">
                                ...
                                <div class="form-note-s2 text-center pt-4"> New on our platform? <a href="sign-up.php">Create an account</a>
                                </div>
                            </div>
                        </div>
                    </div>
