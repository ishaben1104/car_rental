                    ...
                    <div class="col-lg-8">
                        <div class="row">
                            <div class="col-lg-12 col-md-12 d-lg-flex">
                                <div class="blog grid-blog">
                                    <div class="blog-image-list">
                                        <a href="blog-details.php"><img class="img-fluid" src="assets/img/blog/blog-list-01.jpg" alt="Post Image"></a>
                                    </div>
                                    <div class="blog-content">
                                        ...
                                        <h3 class="blog-title"><a href="blog-details.php">Tesla Model S: Top Secret Car Collector’s Garage</a></h3>
                                        ...
                                        <a href="blog-details.php" class="viewlink btn btn-primary justify-content-center">Read More <i class="feather-arrow-right ms-2"></i></a>
                                    </div>
                                </div>
                            </div>
                            <div class="col-lg-12 col-md-12 d-lg-flex">
                                <div class="blog grid-blog">
                                    <div class="blog-image-list">
                                        <a href="blog-details.php"><img class="img-fluid" src="assets/img/blog/blog-list-02.jpg" alt="Post Image"></a>
                                    </div>
                                    <div class="blog-content">
                                        <div class="blog-list-date">
                                            <ul class="meta-item-list">
                            ...
                            <div class="col-lg-12 col-md-12 d-lg-flex">
                                <div class="blog grid-blog">
                                    <div class="blog-image-list">
                                        <a href="blog-details.php"><img class="img-fluid" src="assets/img/blog/blog-list-03.jpg" alt="Post Image"></a>
                                    </div>
                                    <div class="blog-content">
                                        <div class="blog-list-date">
                                            <ul class="meta-item-list">
                            ...
                            <div class="col-lg-12 col-md-12 d-lg-flex">
                                <div class="blog grid-blog">
                                    <div class="blog-image-list">
                                        <a href="blog-details.php"><img class="img-fluid" src="assets/img/blog/blog-list-04.jpg" alt="Post Image"></a>
                                    </div>
                                    <div class="blog-content">
                                        <div class="blog-list-date">
                                            <ul class="meta-item-list">
                            ...
                            <div class="card">
                                ...
                                <div class="article">
                                    ...
                                    <div class="article-content">
                                        <h5><a href="blog-details.php">Great Business Tips in 2023</a></h5>
                                ...
                                <div class="article">
                                    ...
                                    <div class="article-content">
                                        <h5><a href="blog-details.php">Excited News About Cars.</a></h5>
                                        <div class="article-date">
                                            <i class="fa-solid fa-calendar-days"></i>
                                ...
                                <div class="article">
                                    ...
                                    <div class="article-content">
                                        <h5><a href="blog-details.php">8 Amazing Tricks About Business</a></h5>
                                        <div class="article-date">
                                            <i class="fa-solid fa-calendar-days"></i>
